...
<br><br>
## オリジンリクエストの制御（Origin Request Policyy）
...
- ビューワーリクエストに含まれていないオリジンリクエストに追加のHTTPヘッダーを追加することもできる。
